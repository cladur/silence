...
//
// void MenuTest::startup(Scene &scene) {
...
// 	scene.get_render_scene().ui_draw.ui_objects.push_back(&billboard_test);
// 	scene.get_render_scene().ui_draw.ui_objects.push_back(&root);
// 	scene.get_render_scene().ui_draw.ui_objects.push_back(&title_root);
// 	scene.get_render_scene().ui_draw.ui_objects.push_back(&credits_root);
// 	scene.get_render_scene().ui_draw.ui_objects.push_back(&back_button_root);
// 	scene.get_render_scene().ui_draw.ui_objects.push_back(&options_root);
// }
//
