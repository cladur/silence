...
MenuDemo::MenuDemo() {
	...
	play_button = UIButton(glm::vec3(0.0f, 200.0f, 0.0f), glm::vec2(300.0f, 300.0f), "Play", "two", "button");
	play_button.hover_texture_name = "button_hover";
	root.add_child(play_button);

	options_button = UIButton(glm::vec3(0.0f, 0.0f, 0.0f), glm::vec2(300.0f, 300.0f), "Options", "two", "button");
	options_button.hover_texture_name = "button_hover";

	root.add_child(options_button);

	credits_button = UIButton(glm::vec3(0.0f, -200.0f, 0.0f), glm::vec2(300.0f, 300.0f), "Credits", "two", "button");
	credits_button.hover_texture_name = "button_hover";
	root.add_child(credits_button);

	title_root = UIAnchor(0.75f, 0.5f);

	title_text = UIText(glm::vec3(0.0f, 0.0f, 0.0f), 1.4f, "Silence", "two");
	...
	credits_text = UIText(glm::vec3(0.0f, 0.0f, 0.0f), 1.2f, "Silence Team", "two");
	...
	back_button = UIButton(glm::vec3(0.0f, -200.0f, 0.0f), glm::vec2(300.0f, 300.0f), "Back", "two", "button");
	...
	master_volume = UIText(glm::vec3(0.0f, 150.0f, 0.0f), 0.66f, "Master Volume", "two");
	...
	plus_button = UIButton(glm::vec3(200.0f, 0.0f, 0.0f), glm::vec2(75.0f, 75.0f), "high", "two", "button_square");
	plus_button.text_scale = 0.5f;

	plus_button.hover_texture_name = "button_hover_square";
	options_root.add_child(plus_button);

	minus_button = UIButton(glm::vec3(-200.0f, 0.0f, 0.0f), glm::vec2(75.0f, 75.0f), "low", "two", "button_square");
