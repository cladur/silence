...
public:
	...
	void draw_box(const glm::vec3 &center, const glm::vec3 &rotation, const glm::vec3 &scale,
			const glm::vec3 &color = glm::vec3(0.0f, 1.0f, 0.0f));

	void draw_box(const glm::vec3 &center, const glm::quat &orientation, const glm::vec3 &scale,
			const glm::vec3 &color = glm::vec3(0.0f, 1.0f, 0.0f));
