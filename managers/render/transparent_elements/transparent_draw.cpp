...
void TransparentDraw::draw(RenderScene &render_scene) {
	auto d_manager = DisplayManager::get();
	static std::vector<TransparentObject> screen_space_objects;
	glm::vec3 cam_pos = render_scene.camera_pos;
	...
	static glm::mat4 view = render_scene.view;
	static glm::mat4 proj = render_scene.projection;
	...
	for (auto &object : objects) {
		...
		view = render_scene.view;
		proj = render_scene.projection;
