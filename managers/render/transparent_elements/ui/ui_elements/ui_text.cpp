...
void UIText::draw() {
	...
	// text_draw::draw_text(text, is_screen_space, position, color, size.x, texture_name, centered_x, centered_y,
...
void UIText::draw(glm::vec3 parent_position, glm::vec2 parent_size) {
	...
	// text_draw::draw_text(text, is_screen_space, position + parent_position, color, size.x, texture_name, centered_x,
